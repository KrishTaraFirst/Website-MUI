...
export default function MegaMenu7({ menuItems, bannerData, popperWidth = 750 }) {
...
MegaMenu7.propTypes = { menuItems: PropTypes.array, bannerData: PropTypes.node, popperWidth: PropTypes.number };
