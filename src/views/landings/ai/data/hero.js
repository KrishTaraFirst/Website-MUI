...
export const hero = {
  chip: {
    ...
    link: { children: 'explore now', href: BUY_NOW_URL, rel: 'noopener noreferrer' }
  },
  ...
  primaryBtn: { children: 'Get Started - It’s Free Now', href: FREEBIES_URL, rel: 'noopener noreferrer' }
};
