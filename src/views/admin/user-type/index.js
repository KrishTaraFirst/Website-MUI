...
import { Box, Typography, Button, Dialog, Tabs, Tab, Link, DialogContent, DialogActions } from '@mui/material';
...
const UserType = () => {
  ...
  const [selectedUserType, setSelectedUserType] = useState('business'); // Selected type for navigation
