...
const TaskList = ({
  ...
  return (
    <div>
      {permissions.includes('VS_Task_View') && (
        <>
          <Box sx={{ mt: 1 }}>
            <TableContainer
              component={Paper}
                  ...
                  {taskList &&
                    ...
                    <TableCell align="left">{service.visa_type}</TableCell> */}
                          ...
                          >
                            <Chip
                              label={
                                service.status === 'pending' ? 'Pending' : service.status === 'completed' ? 'Completed' : 'In Progress'
                              }
                          ...
                          <TableCell align="center">
                            <ActionCell
                              row={service}
                              onEdit={permissions.includes('VS_Task_Edit') ? () => handleEditClick(service) : false}
                              onDelete={
                                permissions.includes('VS_Task_Delete')
                                  ? (id) => {
